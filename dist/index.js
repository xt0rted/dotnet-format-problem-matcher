...
/* harmony import */ var _actions_core_lib_command__WEBPACK_IMPORTED_MODULE_3__ = __nccwpck_require__(351);
/* harmony import */ var _actions_core_lib_command__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__nccwpck_require__.n(_actions_core_lib_command__WEBPACK_IMPORTED_MODULE_3__);
...
async function run() {
    try {
        const action = (0,_actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput)("action");
        const useWorkspace = (0,_actions_core__WEBPACK_IMPORTED_MODULE_2__.getInput)("use-workspace") === "true";
        const matcherFile = useWorkspace ? __nccwpck_require__.ab + "workspace-problem-matcher.json" : __nccwpck_require__.ab + "problem-matcher.json";
        switch (action) {
            case "add":
                (0,_actions_core_lib_command__WEBPACK_IMPORTED_MODULE_3__.issueCommand)("add-matcher", {}, matcherFile);
                break;
            case "remove":
                ...
                (0,_actions_core_lib_command__WEBPACK_IMPORTED_MODULE_3__.issueCommand)("remove-matcher", {
